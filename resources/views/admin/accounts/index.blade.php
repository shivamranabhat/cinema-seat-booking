                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6 px-0">
                                        <div class="dataTables_length d-flex justify-content-end mt-3 mt-lg-0 mt-xl-0 px-0" id="datatable_length">
                                            <a href="{{route('account.create')}}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3">
                                                <i class="btn-inner">
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                            ...
                                                            data-original-title="Edit" href="{{route('account.edit',$account->id)}}" aria-label="Edit"
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" type="button" data-toggle="modal" data-target="#delete_{{ $account->id }}" data-bs-original-title="Delete">
                                                            <span class="btn-inner">
                                                                <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg"
                                                                    stroke="currentColor">
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="delete_{{ $account->id }}" tabindex="-1" role="dialog"
                                ...
                                {{ $accounts->links('vendor.pagination.simple-tailwind') }}
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
