                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                            ...
                                                            href="{{route('movie.edit',$movie->slug)}}"
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" type="button"
                                                            data-toggle="modal"
                                                            data-target="#delete_{{ $movie->slug }}"
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="delete_{{ $movie->slug }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('movie.destroy', $movie->slug) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                ...
                                {{ $movies->links('vendor.pagination.simple-tailwind') }}
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
