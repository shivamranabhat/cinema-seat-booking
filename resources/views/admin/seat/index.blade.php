                        ...
                        <div class="table-responsive">
                            <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                ...
                                <div class="table-responsive my-3">
                                    ...
                                    @else
                                        @foreach ($seats->groupBy('theater_id') as $theaterId => $theaterSeats)
                                            <div class="mb-4">
                                                <h5>
                                                    {{ $theaterSeats->first()->theater ? $theaterSeats->first()->theater->name : 'Unknown Theater' }}
                                                </h5>
                                                                ...
                                                                <td>
                                                                    <div class="flex align-items-center list-user-action">
                                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                                            ...
                                                                            href="{{ route('seat.edit', $seat->slug) }}"
                                                                        ...
                                                                        <a class="btn btn-sm btn-icon btn-danger" type="button"
                                                                            ...
                                                                            data-bs-target="#delete_{{ $seat->slug }}"
                                                                        ...
                                                                        <!-- Modal -->
                                                                        <div class="modal fade" id="delete_{{ $seat->slug }}"
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered"
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer justify-content-center">
                                                                                        ...
                                                                                        <form
                                                                                            action="{{ route('seat.destroy', $seat->slug) }}"
                                                                                            method="POST">
                                                                                            @csrf
                                                                                            @method('DELETE')
                                                                                            <button type="submit"
                                        ...
                                        @endforeach
                                        {{ $seats->links('vendor.pagination.simple-tailwind') }}
                                    @endif
                                </div>
                                <div class="clear"></div>
                            </div>
