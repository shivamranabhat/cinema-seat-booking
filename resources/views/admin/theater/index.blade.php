                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-warning"
                                                            ...
                                                            href="{{route('theater.edit',$theater->slug)}}"
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-danger" type="button"
                                                            data-toggle="modal"
                                                            data-target="#delete_{{ $theater->slug }}"
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="delete_{{ $theater->slug }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('theater.destroy', $theater->slug) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                ...
                                {{ $theaters->links('vendor.pagination.simple-tailwind') }}
                                <div class="clear"></div>
                            </div>
                        </div>
                    </div>
